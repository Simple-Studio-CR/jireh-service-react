package app.simplestudio.com.jireh.reports.db;
...
public class NbDbRefResolver implements DbRefResolver {
    ...
    private MongoCollection<Document> getCollection(String collection) {
        MongoDatabase db = (MongoDatabase) getReactiveMongoDatabaseFactory().getMongoDatabase();
    ...
    public ReactiveMongoDatabaseFactory getReactiveMongoDatabaseFactory() {
        return reactiveMongoDatabaseFactory;
    }

    @Autowired
    public void setReactiveMongoDatabaseFactory(ReactiveMongoDatabaseFactory reactiveMongoDatabaseFactory) {
